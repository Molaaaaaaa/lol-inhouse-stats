import{F as e,I as t,J as n,K as r,L as i,N as a,P as o,W as s,X as c,Y as l,Z as u,at as d,nt as f,rt as p,tt as m}from"./index-24Oe0HUE.js";import{i as h,m as g,s as _,t as v,v as y}from"./DataTable-DLk58eJY.js";var b=i(`<div class="cuts svelte-uigxh0"><!></div>`),x=i(`<section class="cpf svelte-uigxh0" aria-labelledby="cpf-h"><h2 id="cpf-h" class="cap svelte-uigxh0">티어 계산식</h2> <p class="note svelte-uigxh0">점수는 둘이 한 쌍으로 움직입니다. 롤이 MMR 과 LP 를 나눈 것과 같은 구조입니다.</p> <pre class="fml svelte-uigxh0"> </pre> <h3 class="cap svelte-uigxh0"><span class="stp svelte-uigxh0">1</span>이 판에 쓰는 실력 — 실제로 선 라인 기준</h3> <pre class="fml svelte-uigxh0"> </pre> <p class="note svelte-uigxh0"> </p> <h3 class="cap svelte-uigxh0"><span class="stp svelte-uigxh0">2</span>이길 확률 — 팀 대 팀, 다섯 명이 같은 값</h3> <pre class="fml svelte-uigxh0">E = 1 ÷ (1 + 10^((상대 팀 평균 실력 − 우리 팀 평균 실력) ÷ 400))</pre> <p class="note svelte-uigxh0">개인 대 상대 팀으로 재지 않습니다. 밸런스를 맞춘 방에서 강한 멤버는 개인 기대치가 0.8 이어도
